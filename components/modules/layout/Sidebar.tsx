 ...
 * Sidebar de navegación principal. Client Component para manejar estado activo.
 */
    ...
    <aside className="w-[220px] flex-shrink-0 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="px-4 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-semibold text-gray-900">Sistema Vida</span>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-t border-gray-100">
        <p className="text-xs text-gray-400">v0.1.0 · Free tier</p>
      </div>
    </aside>
  )
}
